#Calculador de despesas: Desenvolva um programa com um menu que de acordo com a escolha do usuário ele consiga, adicionar um valor de uma despesa ou exibir o valor total dessas contas e encerrar.
